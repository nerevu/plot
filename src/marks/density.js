...
import {applyFrameAnchor, applyGroupedChannelStyles, applyDirectStyles, applyIndirectStyles, applyTransform, groupZ, offset} from "../style.js";
...
export class Density extends Mark {
  ...
  render(index, {x, y}, channels, dimensions) {
    ...
    const {dx, dy, path} = this;
    return create("svg:g")
        .call(applyIndirectStyles, this, dimensions) // todo rebase
